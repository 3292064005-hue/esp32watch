...
{
    switch (game_id) {
        case GAME_ID_BREAKOUT: return &g_model.game_stats.breakout_hi;
        case GAME_ID_DINO: return &g_model.game_stats.dino_hi;
        case GAME_ID_PONG: return &g_model.game_stats.pong_hi;
        case GAME_ID_SNAKE: return &g_model.game_stats.snake_hi;
        case GAME_ID_TETRIS: return &g_model.game_stats.tetris_hi;
        case GAME_ID_SHOOTER: return &g_model.game_stats.shooter_hi;
        default: return NULL;
    }
}
