...
#ifndef SYSTEM_RUNTIME_INIT_STORAGE_AUTHORITY_FIRST
#define SYSTEM_RUNTIME_INIT_STORAGE_AUTHORITY_FIRST 1
#endif

#ifndef SYSTEM_RUNTIME_INIT_ENABLE_ORDER_ASSERTS
#define SYSTEM_RUNTIME_INIT_ENABLE_ORDER_ASSERTS 1
#endif
